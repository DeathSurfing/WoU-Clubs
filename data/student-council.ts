...
export const teamMembers: TeamMember[] = [
  ...
  {
    id: "aditya-vikram-mahendru",
    name: "Aditya Vikram Mahendru",
    role: "Tech Secratary",
    department: "Tech",
    year: "Second Year",
    photo: "/photos/aditya-vikram-mahendru.webp",
    bio: "Aditya is the Tech Secratary who treats code like art and servers like playgrounds. From building web apps to wiring up automations, he thrives on solving problems with a dash of creativity. When he’s not busy architecting the next big thing, you’ll find him exploring philosophy, gaming, or sketching out new ideas for student projects.",
